...
/*class to change header bg color so visibility on different backgrounds as you scroll*/
class StickyHeader {
	constructor() {
		...
		this.pageSections.each(function(){
			...
			new Waypoint({
				...
				handler: function(direction){
					if(direction == "down"){
						var matchingHeaderLink = currentSection.getAttribute("data-matching-link"); //select those page-sections with matching custom attrib could use jquery here to reset all classes so our links return to default white, add this logic to constructor
						that.headerLinks.removeClass("is-current-link");
