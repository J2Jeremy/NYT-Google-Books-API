...
class RevealOnScroll {
	...
	createWaypoints(){
		var that = this; //save global this so we can access in waypoint handler function, points to class ojb
		this.itemsToReveal.each(function(){ //points to class object
			var currentItem = this; //points to DOM object
			new Waypoint({
